...
const baseOptions =
  '--market btc/usd --side buy --type take-profit-market --size 1';

describe('[COMMAND] Trade: take profit market', () => {
  test('SUCCEEDS: Take profit market order', async () => {
  ...
  test('SUCCEEDS: Timed split take profit market order', async () => {
